LANGUAGES = {
    "ru": {
        ...
        "registration_error": "❌ Ошибка регистрации. Начните заново командой /start",
        "product_selected": "🛍️ Вы выбрали:",
        "personal_selected": "👨‍💻 Выбрано для личного использования",
        "company_selected": "🏢 Выбрано для компании",
    ...
    "en": {
        ...
        "registration_error": "❌ Registration error. Please start over with /start",
        "product_selected": "🛍️ You selected:",
        "personal_selected": "👨‍💻 Selected for personal use",
        "company_selected": "🏢 Selected for company",
